 ...
 * @author Kenyon
 */
public class TestCopy extends javax.swing.JDialog {

    /**
     * Creates new form LogInPage
     */
    public TestCopy(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void signUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpButtonActionPerformed
        try (Socket connector = new Socket("localhost", 2001)) {
            ...
            try (Scanner in = new Scanner(inStream)) {
                ...
                System.out.println("Running GETLIST now");
                out.println("GETLIST");
                System.out.println("Ran GETLIST");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestCopy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TestCopy dialog = new TestCopy(new javax.swing.JFrame(), true);
