...
public class CalcEngine
{
    ...
    {
        System.out.println("Entering numberPressed");
    ...
    public String plus()
    {
        System.out.println("Entering plus");
    ...
    public String minus()
    {
        System.out.println("Entering minus");
        return applyOperator('-');
    }
    ...
    {
        System.out.println("Entering calculateResult");
        switch(lastOperator) {
            case '+':
     ...
     */
    private String applyOperator(char operator)
    {
        System.out.println("Entering applyOperator");
     ...
     */
    private String keySequenceError()
    {
        System.out.println("Entering keySequenceError");
        // Reset everything.
        clear();
        return("A key sequence error has occurred.");
    }
}